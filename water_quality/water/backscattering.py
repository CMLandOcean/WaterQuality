...
def b_bX(C_X: float = 0,
    ...
    # Math: b_{b,X} = C_X * b_{b,X}^* * b_{b,X}^N(\lambda)
    """
...
def b_bNAP(C_X: float = 0,
    ...
    # Math: b_{b,NAP}(\lambda) = \left[C_X * b_{b,X}^* * b_{b,X}^N(\lambda)\right] + \left[C_{Mie} * b_{b, Mie} * (\frac{\lambda}{\lambda_S})^n \right]
    """
...
def b_b(C_X: float = 0,
    ...
    # Math: b_b(\lambda) = b_{b,w}(\lambda) + b_{b, phy}(\lambda) + b_{b, NAP}(\lambda)
    """  
